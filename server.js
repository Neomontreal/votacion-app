...
// Asegura que cada visitante tenga un identificador único de votante (cookie httpOnly)
...
app.post('/api/vote', (req, res) => {
  ...
  // Restricción de ubicación (solo si el admin configuró lat/lng/radio)
...
// ---------- Admin (sin autenticación, uso interno) ----------
